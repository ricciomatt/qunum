...
from .pauli_matrix_mirror import PauliMatrix
import polars as pl
def add_pauliMatricies(O1:PauliMatrix,O2:PauliMatrix, lazy_ops:bool = True)->PauliMatrix:
    from ..pauli_matrix import PauliMatrix as PM
    Data = O1.Data.join(
...
def sub_pauliMatricies(O1:PauliMatrix,O2:PauliMatrix, lazy_ops:bool = True)->PauliMatrix:
    from ..pauli_matrix import PauliMatrix as PM
    Data = O1.Data.join(
        O2.Data, on= ['particle_index', 'basis'], how='outer', suffix="(1)"
    )
