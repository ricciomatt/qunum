...
from ....qobjs.sparse_su2 import PauliMatrix, mk_sparse_basis, PauliState
from ..gateset import *
import torch
...
class SuQCirquit:
    def __init__(
        ...
        self.check_impl()
        if(psi0 is not None):
            assert isinstance(psi0, PauliState), TypeError('psi0 must be PauliState')
    ...
    def act_opers(self, psi:None|PauliState=None, n:int = 0)->PauliMatrix:
